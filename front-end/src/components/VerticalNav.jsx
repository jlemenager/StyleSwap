...
export default function Nav ({ vertUsername, setVertUsername }) {
    return(
        <div className='nav-links-vertical'>
            <Link to='/login' className='vert-link nav-link-vertical'><img className='nav-logo-vert account-link-vert' src="src/images/user-icon-vert-link.png" alt="user-icon" />{vertUsername}</Link>
            <Link to='/' className='vert-link nav-link-vertical'><img className='nav-logo-vert home-link-vert' src="src/images/newsfeed-vert-link.png" alt="newsfeed" /> Newsfeed</Link>
